...
type FinanceValue int

const (
	FIN_PRIZE         FinanceValue = iota // Prize money at the end of the season.
...
type Status0Value int

const (
	STATUS_NONE Status0Value = iota
	STATUS_MAIN
